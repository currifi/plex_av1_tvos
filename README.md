...
<h2>Workaround:</h2><br />
Create <b>Profiles</b> folder and copy the <b><a href="https://github.com/scriptsingh/plex_av1_tvos/blob/main/tvOS.xml">tvOS.xml</a></b> file to the folder and restart your Plex server. 
